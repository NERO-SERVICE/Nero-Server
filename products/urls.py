...
urlpatterns = [
    ...
    path('<str:docId>/', RetrieveProductView.as_view(), name='get_product'),
    path('<str:docId>/update/', UpdateProductView.as_view(), name='update_product'),
    path('<str:docId>/delete/', DeleteProductView.as_view(), name='delete_product'),
]
